...
**
** Created: Thu Oct 17 01:04:18 2013
...
void GraphicsLinearLayoutStretchItemObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GraphicsLinearLayoutStretchItemObject::staticMetaObjectExtraData = {
...
const QMetaObject GraphicsLinearLayoutStretchItemObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GraphicsLinearLayoutStretchItemObject,
      qt_meta_data_GraphicsLinearLayoutStretchItemObject, &staticMetaObjectExtraData }
};
...
static const uint qt_meta_data_GraphicsLinearLayoutObject[] = {
 ...
 // properties: name, type, flags
      27,  187, 0x00095009,
     249,  233, 0x0009510b,
     267,  261, ((uint)QMetaType::QReal << 24) | 0x00095103,
     275,  261, ((uint)QMetaType::QReal << 24) | 0x00095103,
...
void GraphicsLinearLayoutObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        GraphicsLinearLayoutObject *_t = static_cast<GraphicsLinearLayoutObject *>(_o);
        switch (_id) {
        case 0: _t->updateStretch((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->updateSpacing((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->updateAlignment((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< Qt::Alignment(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData GraphicsLinearLayoutObject::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};
...
const QMetaObject GraphicsLinearLayoutObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GraphicsLinearLayoutObject,
      qt_meta_data_GraphicsLinearLayoutObject, &staticMetaObjectExtraData }
};
...
void LinearLayoutAttached::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        LinearLayoutAttached *_t = static_cast<LinearLayoutAttached *>(_o);
        switch (_id) {
        case 0: _t->stretchChanged((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->alignmentChanged((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< Qt::Alignment(*)>(_a[2]))); break;
        case 2: _t->spacingChanged((*reinterpret_cast< QGraphicsLayoutItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData LinearLayoutAttached::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LinearLayoutAttached::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LinearLayoutAttached,
      qt_meta_data_LinearLayoutAttached, &staticMetaObjectExtraData }
};
